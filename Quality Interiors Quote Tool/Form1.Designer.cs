namespace Quality_Interiors_Quote_Tool
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 41.6666679F));
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Absolute, 20F));
            tableLayoutPanel1.Size = new Size(458, 379);
            tableLayoutPanel1.TabIndex = 0;
            // 
            // button1
            // 
            button1.Dock = DockStyle.Fill;
            button1.Location = new Point(23, 79);
            button1.Name = "button1";
            button1.Size = new Size(203, 135);
            button1.TabIndex = 0;
            button1.Text = "Quote Tool";
            button1.UseVisualStyleBackColor = true;
            button1.Click += button1_Click;
            // 
            // button2
            // 
            button2.Location = new Point(232, 79);
            button2.Name = "button2";
            button2.Size = new Size(203, 135);
            button2.TabIndex = 1;
            button2.Text = "Load a Quote";
